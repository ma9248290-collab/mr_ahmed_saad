...
let licenseKey = "AhmedSaad_System"; // 🔒 تثبيت إجباري للسينيور

// الدالة دي بتولد مسار الداتابيز المخصوص للمدرس
function getFirebaseUrl() {
    return `https://el-senior-system-default-rtdb.europe-west1.firebasedatabase.app/AhmedSaad_System/data.json`;
}
...
window.getSafeUid = function() {
    return "AhmedSaad_System"; // 🔒 التثبيت النهائي لمسار الداتا في كل الـ Fetches
};
...
function startRealTimeSync() {
    ...
    const syncUrl = `https://el-senior-system-default-rtdb.europe-west1.firebasedatabase.app/AhmedSaad_System/syncSignal.json`;
